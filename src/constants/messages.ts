...
export const HELP = `Привет, я могу помочь в работе с календарем записи на стенд.
Что бы начать мной пользоваться зарегестрируйте ваш ключ.

Форматы даты и времени
Любую дату можно написать в формате 21.05 и 21 05, а также словами "сегодня", "завтра" и т.д. Время в формате 09:00, 15:30.

Вот список команд, которые я понимаю:

Мой ключ (ключ) - Зарегестрировать ваш ключ

Кто записан (дата) - Посмотреть расписание на день

Запиши меня (дата) с (время - 09:00) до (время - 12:00) - Записаться`
